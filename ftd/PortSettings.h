...
{
public:
  PortSettings() { m_resolveEnvVars = false; }
  PortSettings( std::istream& stream, bool resolveEnvVars = false ) throw( ConfigError );
...
private:
  ...
  friend std::istream& operator>>( std::istream&, PortSettings& ) throw( ConfigError );
  friend std::ostream& operator<<( std::ostream&, const PortSettings& );
};
/*! @} */

std::istream& operator>>( std::istream&, PortSettings& )
throw( ConfigError );
std::ostream& operator<<( std::ostream&, const PortSettings& );
}
